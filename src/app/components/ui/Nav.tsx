    ...
    <nav className="flex flex-col mb-6">
      <div className="flex place-content-between p-4 bg-White rounded-lg">
        ...
        <div className="flex">
          <Link
            href={"/"}
            className={`px-[27px] py-[11px] items-center flex content-center gap-2 rounded-lg ${
              homeActive ? "text-Purple bg-Light-Purple" : "text-Grey"
            }  hover:text-Purple`}
          >
            <Join size={20} />
          ...
          <Link
            href={"/profile"}
            className={`px-[27px] py-[11px] items-center flex content-center gap-2 rounded-lg ${
              profileActive ? "text-Purple bg-Light-Purple" : "text-Grey"
            }  hover:text-Purple`}
          >
            <UserCircle2 size={20} />
            <span className="font-semibold text-base leading-6 hidden md:block">
        ...
        {user ? (
          ...
          <Link
            href={"/login"}
            className="px-[16px] py-[11px] border rounded-lg bg-Purple text-White font-semibold text-base"
          >
            Sign In
          </Link>
        )}
